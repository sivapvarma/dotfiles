...
defbindings("WMPlex.toplevel", {
    ...
    kpress(ALTMETA.."F2", "mod_query.exec_on_merr(_, XTERM or 'xterm -fg white -bg black')"),
...
defmenu("mainmenu", {
    ...
    menuentry("Terminal",       "mod_query.exec_on_merr(_, XTERM or 'xterm -fg white -bg black')"),
